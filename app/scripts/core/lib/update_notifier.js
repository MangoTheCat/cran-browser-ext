...
module.exports = function(window, options) {
  ...
  if ($('.cran-browser-intro').length > 0) {
    return;
  }
  ...
  var $intro = $('<div class="cran-browser-intro flash flash-notice"><span class="octicon octicon-x flash-close js-flash-close"></span>' + messageHTML + '</div>');
